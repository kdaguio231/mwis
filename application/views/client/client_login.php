...
<head>
  ...
  <title>MWIS | Client Log in</title>
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Sign in as client</p>
      ...
      <form class="form-horizontal" method="post" id="form_login" role="form">
        ...
        <!-- <div class="row"> -->
		  ...
		  <button type="submit" onclick="validate();" name="btnSignIn" id="btnSignIn"  class="btn btn-info col-12" value="true">Login</button><br/><br/>
		  <a href="<?php echo base_url(); ?>" style="margin-left: 100px;" class="text-center">Forgot Password?</a><br/>
		  <div class="_8icz" style="border-bottom: 1px solid #dadde1; display: flex; margin: 20px 16px;">
		  </div>
		  <button type="button" name="btnSignUp" id="btnSignUp" style="width: 130px; margin-left: 100px;" class="btn btn-success" value="true"><a href="<?php echo base_url() . 'client/signup'; ?>" style="color: white">Sign Up</a></button>
   ...
   if(!isset($login_button))
   {
    ...
    echo '<h3><b>Name : </b>'.$user_data["customer_fname"].' '.$user_data['customer_lname']. '</h3>';
    echo '<h3><b>Email :</b> '.$user_data['email_address'].'</h3>';
    echo '<h3><a href="'.base_url().'client/logout">Logout</h3></div>';
   }
   else
   {
...
<script type="text/javascript">
	...
	function signUp()
	{
		window.location.href = '<?php echo base_url(); ?>' + 'client/signup';
	}
	...
	function validate()
	{
		...
		$("#form_login").validate({
			...
			submitHandler: function() {
				$.ajax({
					url: '<?php echo base_url(); ?>client/validation',
                    method: 'POST',
