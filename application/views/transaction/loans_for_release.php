        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Loans For Release</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title"><b>Loans for Release</b></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
							<div class="row">
	...
	$(document).ready(function()
	{
		load_table = function(){
			...
			$("#datatable_loans").dataTable(
			{
				...
				"deferLoading": 0,
				"ajax": {
				"url":"<?php echo base_url(); ?>transaction/load_loan_for_release_list",
				"dataSrc": function (d) {
						return d
					}
				...
				"columns": [
						...
						{ data: 'payment_status'},
						{
							...
							"render": function ( data, type, full, meta ) {
								...
								return '<button id='+buttonID+' class="btn btn-success btn-xs" onclick="loan_release(this)" role="button">Release Loan Amount</button> <a href="<?php echo base_url()?>transaction/loan_details/'+full.application_id+'" id='+buttonID+' class="btn btn-success btn-xs" role="button">Details</a>';
							}
						}
					],
				"columnDefs" : [
